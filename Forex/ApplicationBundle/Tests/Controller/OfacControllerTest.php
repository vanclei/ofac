...
namespace Forex\ApplicationBundle\Tests\Controller;

use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class OfacControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/ofac/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'ofac[firstname]' => 'First value',
            'ofac[lastname]' => 'First value',
            'ofac[type]' => 'First value',
            'ofac[details]' => 'First value',
            'ofac[created]' => 'First value',
            'ofac[updated]' => 'First value',
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/ofac/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'ofac[firstname]' => 'Changed',
            'ofac[lastname]' => 'Changed',
            'ofac[type]' => 'Changed',
            'ofac[details]' => 'Changed',
            'ofac[created]' => 'Changed',
            'ofac[updated]' => 'Changed',
            // ... adapt fields value here ...
        ));
        $client->submit($form);
        $crawler = $client->followRedirect();
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'ofac_filter[firstname]' => 'First%',
            'ofac_filter[lastname]' => 'First%',
            'ofac_filter[type]' => 'First%',
            'ofac_filter[details]' => 'First%',
            'ofac_filter[created]' => 'First%',
            'ofac_filter[updated]' => 'First%',
